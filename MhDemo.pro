...
unrealRootPath=/home/bcrist/development/engine/UnrealEngine
MhDemoRootPath=/home/bcrist/development/lonelyCart/MhDemo

gameProjectFile=/home/bcrist/development/lonelyCart/MhDemo/MhDemo.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MhDemoSource.pri)
include(MhDemoHeader.pri)
include(MhDemoConfig.pri)
include(MhDemoIncludes.pri)
include(MhDemoDefines.pri)
...
MhDemo-Linux-Debug.commands = $$build MhDemo Linux Debug  -project="\"$$gameProjectFile\"" $$args
MhDemo-Linux-DebugGame.commands = $$build MhDemo Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MhDemo-Linux-Shipping.commands = $$build MhDemo Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MhDemo-Linux-Test.commands = $$build MhDemo Linux Test  -project="\"$$gameProjectFile\"" $$args
MhDemo.commands = $$build MhDemo Linux Development  -project="\"$$gameProjectFile\"" $$args

MhDemoEditor-Linux-Debug.commands = $$build MhDemoEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MhDemoEditor-Linux-DebugGame.commands = $$build MhDemoEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MhDemoEditor-Linux-Shipping.commands = $$build MhDemoEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MhDemoEditor-Linux-Test.commands = $$build MhDemoEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MhDemoEditor.commands = $$build MhDemoEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MhDemo-Linux-Debug \
	MhDemo-Linux-DebugGame \
	MhDemo-Linux-Shipping \
	MhDemo-Linux-Test \
	MhDemo \
	MhDemoEditor-Linux-Debug \
	MhDemoEditor-Linux-DebugGame \
	MhDemoEditor-Linux-Shipping \
	MhDemoEditor-Linux-Test \
	MhDemoEditor \
