...
MhDemo-Linux-Debug:
	 $(PROJECTBUILD) MhDemo Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemo-Linux-DebugGame:
	 $(PROJECTBUILD) MhDemo Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemo-Linux-Shipping:
	 $(PROJECTBUILD) MhDemo Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemo-Linux-Test:
	 $(PROJECTBUILD) MhDemo Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemo:
	 $(PROJECTBUILD) MhDemo Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemoEditor-Linux-Debug:
	 $(PROJECTBUILD) MhDemoEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemoEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MhDemoEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemoEditor-Linux-Shipping:
	 $(PROJECTBUILD) MhDemoEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemoEditor-Linux-Test:
	 $(PROJECTBUILD) MhDemoEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MhDemoEditor:
	 $(PROJECTBUILD) MhDemoEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
